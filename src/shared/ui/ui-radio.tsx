...
error
	...
	return (
		<div className={clsx(classNameBlock, '')}>
			<label className={clsx(className, 'text-app-white w-full')}>
					...
					className={clsx(
						'',
						{
							...
							secondary:
								...
								`${error?'border-2 border-app-red':''} flex h-full items-center justify-center rounded-md bg-app-gray py-3 text-app-white duration-300 peer-checked:bg-app-green peer-checked:text-app-dark`
						}[variant]
					)}
				>
					{title && title}
